...
print "Starting Segmentation and Calling...\n";
 system qq(R --slave --args $Main_Output_Folder_Path,$R_Target_Folder,$Input_File_Path,$Mode,$Target_Name,$Program_Folder_Path,$Assembly < $Program_Folder_Path/lib/R/XCAVATORInferenceGenome.R);
print "Segmentation and Calling Complete\n";



# #system qq(R --slave --args $Main_Output_Folder_Path,$Program_Folder_Path/.Ainput.$ID < $Program_Folder_Path/lib/R/EXCAVATORPlots.R);
# 
