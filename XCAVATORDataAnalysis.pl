...
=head1 SYNOPSIS 
 ...
 XCAVATOR> perl XCAVATORDataAnalysis.pl ExperimentalFileAnalysis.txt --processors 6 --target w1000 --assembly hg19 --output /.../OutXCAVATOR/Results_MyProject_w50K --mode pooling/paired/nocontrol
